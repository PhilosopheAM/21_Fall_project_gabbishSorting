...
class Ui_MainWindow(object):
    def __init__(self):
        ...
        self.relaxingScreen_pictures_dict = {
            ...
            4: "background-image:url(E:/python learing/GUI/faceChanging 5.png)",
            5: "background-image:url(E:/python learing/GUI/faceChanging 4.png)",
            6: "background-image:url(E:/python learing/GUI/faceChanging 4.png)",
