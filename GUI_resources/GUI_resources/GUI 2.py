...
class Ui_MainWindow(object):
    def __init__(self):
        ...
        self.relaxingScreen_pictures_dict = {
            ...
            3: "background-image:url(E:/python learing/GUI/faceChanging 2.jpg)",
            4: "background-image:url(E:/python learing/GUI/faceChanging 3.png)",
            ...
            7: "background-image:url(E:/python learing/GUI/faceChanging 4.png)",
            ...
            10: "background-image:url(E:/python learing/GUI/faceChanging 3.png)",
            11: "background-image:url(E:/python learing/GUI/faceChanging 2.jpg)",
...
#定义按钮点击事件
    ...
    def timer_for_pictures_changing(self):
        ...
        if self.pushButton_screenRelax.objectName()!="pushButton_screenRelax" and self.pushButton.objectName()=="pushButton" and self.pushButton_2.objectName()=="pushButton2":
            timer.start()
        print('杰哥不要啊！！！')
    ...
    def timer_for_faceChaing(self):
        ...
        self.pushButton_screenRelax.setStyleSheet()
